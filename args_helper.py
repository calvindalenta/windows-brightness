...
class Args():
    ...
    def init(self):
        ...
        start_one = subparser_start.add_parser("one",
                                               help="Expects a window's name and brightness if true. Example: \"'Mywebsite - Chrome' 40\"")
        ...
        start_file.add_argument("path", type=str, help="The csv file path. Look at example.csv for reference")
